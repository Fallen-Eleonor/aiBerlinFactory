  ...
  return (
    <div className="fixed inset-0 z-30 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
      ...
      >
        ...
        <div className="grid min-h-[620px] lg:grid-cols-[240px_1fr_420px]">
          ...
          <section className="relative flex items-center justify-center overflow-hidden border-r p-6" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
            <div
            ...
            />
            <svg viewBox="0 0 680 520" className="relative z-10 h-full w-full">
              <defs>
              ...
              <circle cx="170" cy="260" r="84" fill="rgba(255,255,255,0.03)" stroke={meta.color} strokeWidth="2.5" />
              <circle cx="510" cy="260" r="84" fill="rgba(255,255,255,0.03)" stroke="rgba(255,255,255,0.3)" strokeWidth="2" />

              <path
                d="M 255 260 C 330 180, 350 340, 425 260"
                fill="none"
              ...
              <circle cx="170" cy="260" r="34" fill={`${meta.color}22`} stroke={meta.color} strokeWidth="1.5" />
              <circle cx="510" cy="260" r="34" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.22)" strokeWidth="1.5" />

              <text x="170" y="267" textAnchor="middle" fill="#fff" fontSize="24">
                {meta.icon}
              </text>
              <text x="510" y="267" textAnchor="middle" fill="#fff" fontSize="22">
                👤
              </text>

              <text x="170" y="370" textAnchor="middle" fill={meta.color} fontSize="18" fontWeight="700">
                {meta.label} Agent
              </text>
              <text x="170" y="398" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="13">
                {link.subtitle}
              </text>

              <text x="510" y="370" textAnchor="middle" fill="#fff" fontSize="18" fontWeight="700">
                Founder
              </text>
              <text x="510" y="398" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="13">
                Human approval or clarification
              </text>

              <rect x="274" y="228" width="132" height="64" rx="16" fill="rgba(8,10,18,0.9)" stroke="rgba(255,255,255,0.12)" />
              <text x="340" y="252" textAnchor="middle" fill="rgba(255,255,255,0.42)" fontSize="11" letterSpacing="2">
                CURRENT LINK
              </text>
              <text x="340" y="276" textAnchor="middle" fill="#fff" fontSize="15" fontWeight="700">
                {chip.label}
              </text>
            </svg>
          </section>
